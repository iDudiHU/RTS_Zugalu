...
public class PlayerInput : MonoBehaviour
{
    ...
    {
        var ray = Camera.ScreenPointToRay(_inputActions.GameplayActionMap.MousePosition.ReadValue<Vector2>());
    ...
    private void HandleSelectionInputs()
    {
        ...
        else if (Mouse.current.leftButton.wasReleasedThisFrame)
        {
            ...
            {
                if (_inputActions.GameplayActionMap.SelectModifier.WasPressedThisFrame() && unit != null)
                {
